...
export default function App() {
    ...
    return (
        <>
            ...
            <div className={`${visible ? "visible" : "invisible"} md:visible h-screen z-0`}>
                <div className="relative h-full">
                    ...
                    <div className="mt-10 bg-slate-300 md:bg-white py-10">
                        ...
                        <div className="flex flex-col md:flex-row items-center md:justify-center my-10 md:my-20 space-y-8 md:space-y-0 md:space-x-8">
                            {boxes.map((box) => (
                                <div className="flex flex-col justify-center items-center w-1/2 md:w-1/4 py-6 space-y-3 bg-veryDarkBlue rounded-lg border border-gray-200 shadow-md cursor-pointer">
