...
const importData = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const createdPoliza = yield poliza_1.Poliza.insertMany(data_1.poliza);
        // Inserto Cuota
        data_1.cuota.poliza = createdPoliza[0]._id;
        yield cuota_1.Cuota.insertMany(data_1.cuota);
    }
    catch (error) {
        console.error(error);
        process.exit(1);
...
const deleteMany = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield cuota_1.Cuota.deleteMany();
});
